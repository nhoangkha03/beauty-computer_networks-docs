...
const devices = [
    {
        ...
        cons: [
            "Gửi dữ liệu lung tung",
            "Dễ nghẽn mạng",
            "Kém bảo mật",
            "Gần như không dùng trong mạng hiện đại",
        ],
        color: "yellow",
        icon: <Share2 />,
    },
    {
        ...
        pros: [
            ...
            "Hiệu năng cao",
            "Bảo mật hơn Hub",
            "Rất phổ biến trong LAN",
        ],
        cons: [
            "Đắt hơn Hub",
            "Switch quản lý cần cấu hình",
            "Muốn đi Internet vẫn cần Router",
        ],
        color: "cyan",
        icon: <EthernetPort />,
    },
    {
        ...
        pros: [
            "Kết nối được nhiều mạng",
            "Chọn đường đi cho dữ liệu",
            "Có NAT, DHCP, firewall cơ bản",
            "Rất quan trọng trong mạng hiện đại",
        ],
        cons: [
            "Phức tạp hơn Switch",
            "Cần cấu hình đúng",
            "Router yếu có thể gây nghẽn",
        ],
        color: "emerald",
        icon: <Router />,
    },
    {
        ...
        pros: [
            "Nối được với nhà mạng",
            "Chuyển đổi tín hiệu đường truyền",
            "Là điểm vào Internet của đường truyền",
        ],
        cons: [
            "Không thay thế vai trò Router đầy đủ",
            "Phụ thuộc loại đường truyền",
            "Dễ bị nhầm với Router WiFi tích hợp",
        ],
        color: "orange",
        icon: <SatelliteDish />,
    },
    {
        ...
        pros: [
            "Phát WiFi",
            "Nối thiết bị không dây vào LAN",
            "Mở rộng vùng phủ sóng",
            "Hỗ trợ roaming trong hệ thống lớn",
        ],
        cons: [
            "Không nhất thiết là Router",
            "Cần đặt vị trí hợp lý",
            "Nhiễu sóng có thể làm mạng chậm",
        ],
        color: "purple",
        icon: <Wifi />,
    },
            ...
            <div className="relative grid md:grid-cols-[1.05fr_0.95fr] gap-8 items-center">
                <div className="space-y-5">
                    ...
                    <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
                        Bài này giúp bạn đọc một sơ đồ mạng gia đình hoặc công
                        ty và biết thiết bị nào chia mạng LAN, thiết bị nào phát
                        WiFi, thiết bị nào đưa mạng ra Internet.
                    </p>
                    <div className="bg-slate-950/70 border border-slate-800 rounded-2xl p-5 font-mono text-sm max-w-xl">
                        <p className="text-slate-500">// Ghi nhớ nhanh</p>
                        <p>
                            <span className="text-cyan-300">Switch</span> trong
                            LAN,{" "}
                            <span className="text-emerald-300">Router</span> ra
                            mạng khác,{" "}
                            <span className="text-orange-300">Modem</span> nối
                            ISP, <span className="text-purple-300">AP</span>{" "}
                            phát WiFi.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="mt-5 grid grid-cols-5 gap-2">
                        {devices.map((device) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`${c.text} flex justify-center mb-2`}
                                    >
                                        {React.cloneElement(device.icon, {
                                            size: 23,
                                        })}
                                    </div>
        ...
        <section className="space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8">
                <p className="text-slate-300 leading-relaxed mb-8">
                    Trong bài trước, bạn đã học topology Star thường có thiết bị
                    trung tâm. Bài này đi vào các thiết bị cụ thể:{" "}
                    <strong className="text-white">
                        Hub, Switch, Router, Modem, AP
                    </strong>
                    . Chúng có thể nằm riêng hoặc được tích hợp chung trong một
                    thiết bị vật lý.
                </p>
                ...
                <div className="mt-8 bg-blue-500/10 border border-blue-500/20 rounded-2xl p-5 text-sm text-slate-300">
                    <strong className="text-blue-300">Điểm dễ nhầm:</strong> Một
                    “cục WiFi” ở nhà thường không chỉ là một thiết bị đơn chức
                    năng. Nó có thể tích hợp Router + Switch nhỏ + AP, thậm chí
                    cả Modem/ONT.
                </div>
            </div>
        </section>
        ...
        <section className="space-y-6">
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden">
                ...
                <div className="p-6 md:p-8 grid lg:grid-cols-[0.95fr_1.05fr] gap-8 items-start">
                    <div
                        className={`${c.bg} ${c.border} border rounded-3xl p-6`}
                    >
                        <div
                        ...
                        <p
                            className={`${c.text} font-black text-sm uppercase tracking-wider`}
                        >
                            {active.viName}
                        </p>
                        <h3 className="text-3xl font-extrabold text-white mt-2 mb-3">
                            {active.label}
                        </h3>
                    ...
                    <div className="space-y-4">
                        <InfoBox
                            title="Hoạt động dựa trên"
                            value={active.basedOn}
                            icon={<FileSearch />}
                            color={active.color}
                        />
                        <InfoBox
                            title="Thường dùng ở đâu?"
                            value={active.usedIn}
                            icon={<MapPin />}
                            color={active.color}
                        />
    ...
    return (
        <section className="space-y-6">
            <SectionTitle
                number="4"
                color="yellow"
                title="Hub và Switch khác nhau thế nào?"
                icon={<Split />}
            />
            <div className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden">
                <div className="flex gap-2 p-2 bg-slate-950/60 border-b border-slate-800">
                    <button
                        onClick={() => setMode("hub")}
                        className={`px-4 py-2.5 rounded-xl font-bold text-sm transition-colors ${isHub ? "bg-yellow-500 text-slate-950" : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"}`}
                    >
                        Hub gửi lung tung
                    </button>
                    <button
                        onClick={() => setMode("switch")}
                        className={`px-4 py-2.5 rounded-xl font-bold text-sm transition-colors ${!isHub ? "bg-cyan-500 text-white" : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"}`}
                    >
                ...
                <div className="p-6 md:p-8 grid lg:grid-cols-[1fr_1fr] gap-8 items-center">
                    <div
                        className={`${isHub ? "bg-yellow-500/10 border-yellow-400/40" : "bg-cyan-500/10 border-cyan-400/40"} border rounded-3xl p-6`}
                    >
                        <h3 className="text-2xl font-bold text-white mb-3">
                            PC1 gửi dữ liệu cho PC3
                        </h3>
                    ...
                    <div className="space-y-4">
                        <CompareCard
                            ...
                            color="yellow"
                            lines={[
                                "Gửi dữ liệu ra tất cả cổng",
                                "Dễ nghẽn và kém bảo mật",
                                "Gần như không dùng trong mạng hiện đại",
                            ]}
                            active={isHub}
                        />
                        <CompareCard
                            ...
                            color="cyan"
                            lines={[
                                "Gửi dữ liệu đúng cổng",
                                "Dựa vào MAC address",
                                "Phổ biến trong LAN hiện đại",
                            ]}
                            active={!isHub}
                        />
                    </div>
    ...
    return (
        <section className="space-y-6">
            <SectionTitle
                number="5"
                color="purple"
                title="Router, Modem và AP khác nhau thế nào?"
                icon={<CircleHelp />}
            />
            <div className="grid md:grid-cols-3 gap-4">
                {cards.map((card) => {
                    ...
                    return (
                        <div
                            key={card.title}
                            className={`${c.bg} ${c.border} border rounded-3xl p-6 hover:-translate-y-1 transition-all`}
                        >
                            <div
                            ...
                            <p className={`${c.text} font-bold mb-3`}>
                                {card.main}
                            </p>
                            <p className="text-sm text-slate-300 leading-relaxed">
                                {card.detail}
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8">
                <h3 className="text-xl font-bold text-white mb-6">
                    Thiết bị WiFi gia đình thường tích hợp nhiều vai trò
                </h3>
                <div className="grid md:grid-cols-4 gap-4">
                    <IntegratedRole
                        icon={<Router />}
                        title="Router"
                        desc="Định tuyến, NAT, DHCP"
                        color="emerald"
                    />
                    <IntegratedRole
                        icon={<EthernetPort />}
                        title="Switch nhỏ"
                        desc="Có vài cổng LAN phía sau"
                        color="cyan"
                    />
                    <IntegratedRole
                        icon={<Wifi />}
                        title="AP"
                        desc="Phát WiFi 2.4GHz/5GHz"
                        color="purple"
                    />
                    <IntegratedRole
                        icon={<SatelliteDish />}
                        title="Modem/ONT"
                        desc="Có thể tích hợp tùy thiết bị nhà mạng"
                        color="orange"
                    />
                </div>
            </div>
    ...
    return (
        <section className="space-y-6">
            <SectionTitle
                number="6"
                color="blue"
                title="Sơ đồ mạng gia đình và công ty"
                icon={<Home />}
            />
            <div className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden">
                <div className="flex gap-2 p-2 bg-slate-950/60 border-b border-slate-800">
                    <button
                        ...
                        className={`px-4 py-2.5 rounded-xl font-bold text-sm transition-colors ${mode === "home" ? "bg-blue-500 text-white" : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"}`}
                    >
                        Mạng gia đình
                    </button>
                    <button
                        onClick={() => setMode("company")}
                        className={`px-4 py-2.5 rounded-xl font-bold text-sm transition-colors ${mode === "company" ? "bg-blue-500 text-white" : "text-slate-400 hover:bg-slate-800 hover:text-slate-200"}`}
                    >
                        Mạng công ty nhỏ
                    </button>
                </div>
    ...
    return (
        <section className="space-y-6">
            <SectionTitle
                number="7"
                color="emerald"
                title="Dữ liệu đi qua các thiết bị như thế nào?"
                icon={<Activity />}
            />
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8">
                <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-8 items-center">
                    <div
                        className={`${c.bg} ${c.border} border rounded-3xl p-6 min-h-[345px] flex flex-col justify-between`}
                    >
                        <div>
                            <div
                                className={`${c.solid} w-16 h-16 rounded-2xl text-white flex items-center justify-center shadow-lg ${c.ring} mb-5`}
                        ...
                        <div className="mt-6 space-y-3">
                            {steps.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 text-sm font-bold ${step === index ? `${ic.solid} text-white` : index < step ? "bg-green-500/20 text-green-400" : "bg-slate-950 text-slate-500"}`}
                                        >
                                            {index < step ? (
                ...
                <div className="bg-green-500/5 border border-green-500/20 rounded-3xl p-6">
                    ...
                    <div className="mt-6 grid gap-3">
                        <ExplainRow
                            ...
                            desc="Cổng mặc định để thiết bị đi ra mạng khác, thường là Router."
                        />
                        <ExplainRow
                            term="DNS"
                            desc="Hệ thống biến tên miền như google.com thành địa chỉ IP."
                        />
                        <ExplainRow
                            term="ISP"
                            desc="Internet Service Provider — nhà cung cấp dịch vụ Internet."
                        />
                    </div>
                </div>
            </div>
    ...
    return (
        <section className="space-y-6">
            <SectionTitle
                number="9"
                color="yellow"
                title="Một số hiểu nhầm thường gặp"
                icon={<AlertTriangle />}
            />
                ...
                <div className="p-6 md:p-8 grid lg:grid-cols-[0.95fr_1.05fr] gap-8">
                    <div>
                        ...
                        <div className="font-mono text-sm bg-slate-950 p-6 rounded-2xl text-green-400 border border-slate-800 shadow-inner space-y-2">
                            ...
                            <p>
                                <span className="text-cyan-300">Switch</span> =
                                gửi đúng thiết bị trong LAN
                            </p>
                            <p>
                                <span className="text-emerald-300">Router</span>{" "}
                                = nối các mạng khác nhau, đưa LAN ra Internet
                            </p>
                            <p>
                                <span className="text-orange-300">Modem</span> =
                                nối nhà/công ty với nhà mạng
                            </p>
                            <p>
                                <span className="text-purple-300">AP</span> =
                                phát WiFi cho thiết bị không dây
                            </p>
                            <br />
                            <p className="text-slate-500"># Cặp dễ nhầm</p>
                            <p className="text-slate-300">
                                Switch dùng MAC, Router dùng IP.
                            </p>
                            <p className="text-slate-300">
                                Modem nối ISP, Router định tuyến.
                            </p>
                            <p className="text-slate-300">
                                AP phát WiFi, không nhất thiết là Router.
                            </p>
                        </div>
                    </div>
                    <InteractiveQuiz />
...
const questions = [
    {
        question:
            "Thiết bị nào thường dùng để kết nối nhiều máy tính bằng dây trong cùng một mạng LAN?",
        options: ["Modem", "Switch", "AP", "Màn hình"],
        correct: 1,
        explanation:
            "Switch là thiết bị phổ biến để kết nối nhiều thiết bị có dây trong cùng mạng LAN.",
    },
    {
        ...
        correct: 1,
        explanation:
            "Switch chuyển dữ liệu trong cùng LAN dựa vào MAC; Router kết nối các mạng khác nhau dựa vào IP.",
    },
    {
        question:
            "Trong sơ đồ Phone ))) AP ---- Switch ---- Router ---- Modem ---- Internet, thiết bị nào phát WiFi?",
        options: ["AP", "Switch", "Modem", "Server"],
        correct: 0,
        explanation:
            "AP là Access Point, nhiệm vụ chính là phát WiFi để thiết bị không dây truy cập vào LAN.",
    },
    {
        question:
            "Thiết bị nào kết nối nhà bạn/công ty với nhà cung cấp Internet?",
        options: ["Switch", "AP", "Modem", "Máy in"],
        correct: 2,
        explanation:
            "Modem/ONT là thiết bị kết nối đường truyền nhà mạng với mạng phía trong.",
    },
    {
        question:
            "Nếu ping 8.8.8.8 được nhưng ping google.com không được, khả năng cao lỗi ở đâu?",
        options: ["Màn hình", "DNS", "Bàn phím", "Dây sạc"],
        correct: 1,
        explanation:
            "Ping IP được nghĩa là có đường ra Internet theo IP. Ping tên miền không được thường gợi ý lỗi DNS.",
    },
];
    ...
    return (
        <div className="text-center pt-8 border-t border-slate-800">
            <p className="text-slate-400 mb-4">
                Sau khi biết thiết bị mạng làm gì, bài tiếp theo sẽ học dữ liệu
                đi qua môi trường truyền dẫn nào.
            </p>
            <Link
                to="/phan-1-5"
            ...
            >
                Bài tiếp theo: 1.5 — Đường truyền có dây, cáp quang và không dây{" "}
            ...
            {items.map((item, index) => {
                ...
                return (
                    <div key={item.label} className="flex items-center gap-3">
                        <div
                            className={`${c.bg} ${c.border} ${c.text} border rounded-2xl w-11 h-11 flex items-center justify-center shrink-0`}
                        >
                            {React.cloneElement(item.icon, { size: 22 })}
                        </div>
                        <div className="text-white font-bold text-sm flex-1">
                            {item.label}
                        </div>
...
function DeviceSummaryCard({ device }) {
    ...
    return (
        <div
            className={`${c.bg} ${c.border} border rounded-3xl p-5 hover:-translate-y-1 transition-all`}
        >
            <div className={`${c.text} mb-4`}>
                {React.cloneElement(device.icon, { size: 30 })}
            </div>
            <h3 className="text-white font-black text-lg mb-1">
                {device.label}
            </h3>
            <p className={`${c.text} text-xs font-bold mb-3`}>
                {device.viName}
            </p>
...
function InfoBox({ title, value, icon, color }) {
    ...
    return (
        <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 flex gap-4 items-start">
            <div
                className={`${c.bg} ${c.text} w-10 h-10 rounded-xl flex items-center justify-center shrink-0`}
            >
                {React.cloneElement(icon, { size: 20 })}
            </div>
            <div>
    ...
    return (
        <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-green-500/5 border border-green-500/20 rounded-2xl p-5">
                <h4 className="text-green-300 font-bold mb-4 flex items-center gap-2">
                    <CheckCircle2 size={18} /> Ưu điểm
                </h4>
            ...
            <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-5">
                <h4 className="text-red-300 font-bold mb-4 flex items-center gap-2">
                    <XCircle size={18} /> Nhược điểm
                </h4>
                <ul className="space-y-3">
                    {cons.map((item) => (
                        <li
...
function HubSwitchDiagram({ mode }) {
    ...
    return (
        <div className="relative min-h-[280px] bg-slate-950 border border-slate-800 rounded-3xl p-6 overflow-hidden">
            ...
            <div
                className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-3xl ${centerColor} flex items-center justify-center font-black shadow-lg z-10`}
            >
                {isHub ? "HUB" : "SW"}
            </div>
        </div>
...
function Node({ label, active, target, className }) {
    return (
        <div
            className={`${className} z-20 w-16 h-16 rounded-2xl border flex flex-col items-center justify-center ${target ? "bg-green-500/10 border-green-400/40 text-green-300" : active ? "bg-blue-500/10 border-blue-400/40 text-blue-300" : "bg-slate-900 border-slate-700 text-slate-300"}`}
        >
            <Laptop size={20} />
...
function CompareCard({ title, icon, color, lines, active }) {
    ...
    return (
        <div
            className={`${active ? `${c.bg} ${c.border}` : "bg-slate-950 border-slate-800"} border rounded-3xl p-5`}
        >
            <h4
                className={`${active ? c.text : "text-slate-400"} font-black text-lg mb-4 flex items-center gap-2`}
            >
                {React.cloneElement(icon, { size: 20 })} {title}
            </h4>
            <ul className="space-y-3">
                {lines.map((line) => (
                    <li
                    ...
                    >
                        <CheckCircle2
                            size={16}
                            className={`${active ? c.text : "text-slate-500"} shrink-0 mt-0.5`}
                        />{" "}
                        {line}
                    </li>
                ))}
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-sm text-slate-400">
                Trong nhiều trường hợp, Router WiFi ở nhà tích hợp Router +
                Switch nhỏ + Access Point + đôi khi cả Modem.
            </p>
        </div>
    );
}
...
function CompanyNetworkDiagram() {
    return (
        <div className="space-y-6">
            ...
            <p className="text-sm text-slate-400">
                Switch kết nối thiết bị trong LAN; Router/Firewall đưa LAN ra
                mạng ngoài; AP phát WiFi cho thiết bị không dây.
            </p>
        </div>
    );
}
...
function DiagramBox({ icon, label, color, small }) {
    ...
    return (
        <div
            className={`${c.bg} ${c.border} border rounded-2xl ${small ? "w-28 h-20" : "w-32 h-24"} flex flex-col items-center justify-center text-center`}
        >
            <div className={c.text}>
                {React.cloneElement(icon, { size: small ? 22 : 28 })}
            </div>
        ...
        <div className="space-y-3">
            {items.map((item, index) => {
                ...
                return (
                    <div
                        key={item.label}
                        className={`flex items-center gap-3 p-3 rounded-2xl border ${active ? `${c.bg} ${c.border}` : "bg-slate-900 border-slate-800"}`}
                    >
                        <div
                            className={`${active ? c.text : "text-slate-600"}`}
                        >
                            {React.cloneElement(item.icon, { size: 22 })}
                        </div>
                        <span
...
function TerminalButton({ active, onClick, text }) {
    return (
        <button
            onClick={onClick}
            className={`px-4 py-2 rounded-xl text-sm font-bold transition-colors ${active ? "bg-green-500 text-white" : "bg-slate-950 border border-slate-800 text-slate-400 hover:text-slate-200"}`}
        >
            {text}
        </button>
    );
